...
from .adapter import note_toctree
...
class FlexTreeCollector(EnvironmentCollector):
                ...
                # check within the section for other node types
                    ...
                    for toctreenode in sectionnode.findall():
                        if isinstance(toctreenode, nodes.section):
                            continue
                        if isinstance(toctreenode, FlexTreeNode):
    ...
    def assign_section_numbers(self, env: BuildEnvironment) -> list[str]:
        ...
        def _walk_toctree(toctreenode: FlexTreeNode, depth: int) -> None:
            if depth == 0:
                return
        ...
        for docname in env.numbered_toctrees:
            ...
            for toctreenode in doctree.findall(FlexTreeNode):
